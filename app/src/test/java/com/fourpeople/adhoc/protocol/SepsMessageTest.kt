...
class SepsMessageTest {
    ...
    fun testLocationConversion() {
        ...
        assertEquals(10.0, parsed.accuracy ?: 0.0, 0.01)
        assertEquals(45.0, parsed.altitude ?: 0.0, 0.01)
        assertEquals(1.5, parsed.speed ?: 0.0, 0.01)
        assertEquals(180.0, parsed.bearing ?: 0.0, 0.01)
    }
